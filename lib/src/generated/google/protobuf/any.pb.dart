...
class Any extends $pb.GeneratedMessage {
  ...
  T unpackInto<T extends $pb.GeneratedMessage>(T instance,
    ...
    $pb.unpackIntoHelper(value, instance, typeUrl, extensionRegistry: extensionRegistry);
    return instance;
  }
  ...
  static Any pack($pb.GeneratedMessage message, {String typeUrlPrefix = 'type.googleapis.com'}) {
    return new Any()
